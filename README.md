...
Note: I KNOW the font color against the white table/console background is an eye-sore to look at, I just couldn't figure out where in the CSS/scene builder setting that I messed up and couldn't make the background the same as what is shown in the menu page, I'M SORRY SORRY OKAY ;___;
